...
<head>
    ...
    <link rel="icon" href="../../general/assets/lineshareBianco.svg">
...
<header>
        ...
        <a href="../../" class="containerLogo">
            <div class="logo">
                <img src="../../general/assets/lineshareBianco.svg" alt="">
            </div>
        ...
        <div class="destra">
            ...
            <div class="aggiungiTraccia pulsante" style="margin-right: 60px;">
                <i class="fa-regular fa-circle-xmark" style="transform: rotate(45deg);"></i>
                <p>Aggiungi traccia</p>
            </div>

            <div class="Profilo pulsante" onclick="openProfileMenu()">
        ...
        <?php
          ...
          if(isset($_SESSION["loggato"])){
            ...
            echo "
                ...
                <a href='./auth/disconnettiti' class='element'>
            ...
            echo "
            <a href='../../auth/accedi/' class='element'>
                <p>Accedi</p>
            ...
            <a href='../../auth/iscriviti/' class='element'>
                <p>Iscriviti</p>
                <i class='material-symbols-outlined'>
                    arrow_forward_ios
                </i>
